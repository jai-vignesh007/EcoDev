...
// lambda/backfill-coordinator/index.ts
var index_exports = {};
    ...
    for (const repo of repos) {
      ...
      try {
        ...
        const snapshot = {
          ...
          commitSha: "BACKFILL_INITIAL",
          // We don't have a specific commit for backfill
          isPrivate: repo.private,
          isArchived: repo.archived,
          backfillBatch: batchId
        };
        await ddbDocClient.send(new import_lib_dynamodb.PutCommand({
